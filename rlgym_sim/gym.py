...
class Gym(Env):
    def __init__(self, match, copy_gamestate_every_step, visualize=False):
        super().__init__()
        ...
        self._game = RocketSimGame(match, copy_gamestate=copy_gamestate_every_step, visualize=visualize)
